...
| mode    | cmsAction                                      | param              | param desc        | desc |
|---------|------------------------------------------------|--------------------|-------------------|------|
| auth    | login                                          | login<br/>password | string<br/>string |      |
| auth    | exit                                           |                    |                   |      |
| DB      | showTable                                      |                    |                   |      |
| DB      | loadTable                                      |                    |                   |      |
| DB      | loadFormsTable                                 |                    |                   |      |
...
| DB      | changeOrders                                   |                    |                   |      |
| DB      | loadOrders                                     |                    |                   |      |
| DB      | changeStatusOrder                              |                    |                   |      |
| DB      | delOrders                                      |                    |                   |      |
| DB      | saveVisitorOrder                               |                    |                   |      |
| DB      | loadVisitorOrders                              |                    |                   |      |
| DB      | delVisitorOrders                               |                    |                   |      |
| DB      | createSection                                  |                    |                   |      |
| DB      | changeSection                                  |                    |                   |      |
| DB      | openSection                                    |                    |                   |      |
...
| setting | saveColumns                                    |                    |                   |      | 
| setting | load                                           |                    |                   |      | 
| setting | createProperty/createDealersProperty           |                    |                   |      | 
| setting | changeProperty/changeDealersProperty           |                    |                   |      | 
