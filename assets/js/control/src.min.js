...
/******/ 	return __webpack_require__(__webpack_require__.s = "./assets/js/control/src.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./assets/js/control/components/component.js":
/*!***************************************************!*\
  !*** ./assets/js/control/components/component.js ***!
  \***************************************************/
/*! exports provided: Modal, MessageToast, Print, Searching, valid */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Modal", function() { return Modal; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MessageToast", function() { return MessageToast; });
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../const.js */ "./assets/js/const.js");
/* harmony import */ var _func_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../func.js */ "./assets/js/control/func.js");
// МОДУЛИ
//----------------------------------------------------------------------------------------------------------------------
...
const Modal = () => {
  ...
  modal.wrap    = _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].gI('modalWrap');
  ...
  modal.show = function (title = '', content = '') {
    ...
    modal.title && title && _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].eraseNode(modal.title).append(title);
    modal.content && content && _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].eraseNode(modal.content).append(content);
  }
...
// Валидация
const valid = {
  debug: _const_js__WEBPACK_IMPORTED_MODULE_0__["c"].DEBUG,
  valid: new Set(),
  idForm: 'authForm',
  idSubmit: 'btnConfirmSend',

  className: {
    load: _const_js__WEBPACK_IMPORTED_MODULE_0__["c"].CLASS_NAME.LOADING,
  ...
  init(sendFunc, idForm = false, idSubmit = false) {
    ...
    this.form = _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].gI(this.idForm);
    this.btn  = _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].gI(this.idSubmit);
    ...
    _func_js__WEBPACK_IMPORTED_MODULE_1__["f"].maskInit(this.form.querySelector("input[type='tel']"));
  },
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./assets/js/const.js");
/* harmony import */ var _query_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./query.js */ "./assets/js/control/query.js");
  ...
  maskInit: (node) => {
    ...
    const mask = (e) => {
      let target = e.target, i = 0,
          matrix = _const_js__WEBPACK_IMPORTED_MODULE_0__["c"].PHONE_MASK,
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../const.js */ "./assets/js/const.js");
/* harmony import */ var _func_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./func.js */ "./assets/js/control/func.js");
/* harmony import */ var _components_component_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/component.js */ "./assets/js/control/components/component.js");
...
const m = {
  ...
  initModal : _components_component_js__WEBPACK_IMPORTED_MODULE_2__["Modal"],
  ...
  initValid : (sendFunc, idForm, idSubmit) => _components_component_js__WEBPACK_IMPORTED_MODULE_2__["valid"].init(sendFunc, idForm, idSubmit),

  showMsg: (msg, type) => new _components_component_js__WEBPACK_IMPORTED_MODULE_2__["MessageToast"]().show(msg, type),
};

window.f = Object.assign(_const_js__WEBPACK_IMPORTED_MODULE_0__["c"], m, _func_js__WEBPACK_IMPORTED_MODULE_1__["f"]);
