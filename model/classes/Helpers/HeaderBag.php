...
class HeaderBag {
   ...
   */
  public function get(string $key, ?string $default = null, bool $first = true): array|string|null
  {
   ...
   */
  public function set(string $key, array|string $values, bool $replace = true): void
  {
    $key = str_replace('_', '-', strtolower($key));
   ...
   * @param true|mixed $value The Cache-Control directive value
   */
